...
if __name__ == '__main__':
    ...
    val_name = "maatifmutation_{}_{}_multi.txt".format(clf_name,dataset_used)
    ...
    for r in range(repeat_time):
        ...
        for rown in range(len(dataset_orig_test_1)):
            if dataset_orig_test_1.loc[rown, sa0] == 1 and dataset_orig_test_1.loc[rown, sa1] == 0 and \
                    dataset_orig_test_1.loc[rown, sa2] == 1:
                dataset_orig_test_1.loc[rown, sa0] = 0
                dataset_orig_test_1.loc[rown, sa1] = 0
                dataset_orig_test_1.loc[rown, sa2] = 1
            elif dataset_orig_test_1.loc[rown, sa0] == 0 and dataset_orig_test_1.loc[rown, sa1] == 0 and \
                    dataset_orig_test_1.loc[rown, sa2] == 0:
                dataset_orig_test_1.loc[rown, sa0] = 1
                dataset_orig_test_1.loc[rown, sa1] = 0
                dataset_orig_test_1.loc[rown, sa2] = 0
            elif dataset_orig_test_1.loc[rown, sa0] == 1 and dataset_orig_test_1.loc[rown, sa1] == 1 and \
                    dataset_orig_test_1.loc[rown, sa2] == 1:
                dataset_orig_test_1.loc[rown, sa0] = 0
                dataset_orig_test_1.loc[rown, sa1] = 0
                dataset_orig_test_1.loc[rown, sa2] = 1
            elif dataset_orig_test_1.loc[rown, sa0] == 0 and dataset_orig_test_1.loc[rown, sa1] == 1 and \
                    dataset_orig_test_1.loc[rown, sa2] == 1:
                dataset_orig_test_1.loc[rown, sa0] = 0
                dataset_orig_test_1.loc[rown, sa1] = 0
                dataset_orig_test_1.loc[rown, sa2] = 1
        ...
        for rown in range(len(dataset_orig_test_2)):
            if dataset_orig_test_2.loc[rown, sa0] == 1 and dataset_orig_test_2.loc[rown, sa1] == 0 and \
                    dataset_orig_test_2.loc[rown, sa2] == 1:
                dataset_orig_test_2.loc[rown, sa0] = 0
                dataset_orig_test_2.loc[rown, sa1] = 0
                dataset_orig_test_2.loc[rown, sa2] = 1
            elif dataset_orig_test_2.loc[rown, sa0] == 0 and dataset_orig_test_2.loc[rown, sa1] == 0 and \
                    dataset_orig_test_2.loc[rown, sa2] == 0:
                dataset_orig_test_2.loc[rown, sa0] = 1
                dataset_orig_test_2.loc[rown, sa1] = 0
                dataset_orig_test_2.loc[rown, sa2] = 0
            elif dataset_orig_test_2.loc[rown, sa0] == 1 and dataset_orig_test_2.loc[rown, sa1] == 1 and \
                    dataset_orig_test_2.loc[rown, sa2] == 1:
                dataset_orig_test_2.loc[rown, sa0] = 0
                dataset_orig_test_2.loc[rown, sa1] = 0
                dataset_orig_test_2.loc[rown, sa2] = 1
            elif dataset_orig_test_2.loc[rown, sa0] == 0 and dataset_orig_test_2.loc[rown, sa1] == 1 and \
                    dataset_orig_test_2.loc[rown, sa2] == 1:
                dataset_orig_test_2.loc[rown, sa0] = 0
                dataset_orig_test_2.loc[rown, sa1] = 0
                dataset_orig_test_2.loc[rown, sa2] = 1
        ...
        for rown in range(len(dataset_orig_test_3)):
            if dataset_orig_test_3.loc[rown, sa0] == 1 and dataset_orig_test_3.loc[rown, sa1] == 0 and \
                    dataset_orig_test_3.loc[rown, sa2] == 1:
                dataset_orig_test_3.loc[rown, sa0] = 0
                dataset_orig_test_3.loc[rown, sa1] = 0
                dataset_orig_test_3.loc[rown, sa2] = 1
            elif dataset_orig_test_3.loc[rown, sa0] == 0 and dataset_orig_test_3.loc[rown, sa1] == 0 and \
                    dataset_orig_test_3.loc[rown, sa2] == 0:
                dataset_orig_test_3.loc[rown, sa0] = 1
                dataset_orig_test_3.loc[rown, sa1] = 0
                dataset_orig_test_3.loc[rown, sa2] = 0
            elif dataset_orig_test_3.loc[rown, sa0] == 1 and dataset_orig_test_3.loc[rown, sa1] == 1 and \
                    dataset_orig_test_3.loc[rown, sa2] == 1:
                dataset_orig_test_3.loc[rown, sa0] = 0
                dataset_orig_test_3.loc[rown, sa1] = 0
                dataset_orig_test_3.loc[rown, sa2] = 1
            elif dataset_orig_test_3.loc[rown, sa0] == 0 and dataset_orig_test_3.loc[rown, sa1] == 1 and \
                    dataset_orig_test_3.loc[rown, sa2] == 1:
                dataset_orig_test_3.loc[rown, sa0] = 0
                dataset_orig_test_3.loc[rown, sa1] = 0
                dataset_orig_test_3.loc[rown, sa2] = 1
        ...
        for rown in range(len(dataset_orig_test_4)):
            if dataset_orig_test_4.loc[rown, sa0] == 1 and dataset_orig_test_4.loc[rown, sa1] == 0 and \
                    dataset_orig_test_4.loc[rown, sa2] == 1:
                dataset_orig_test_4.loc[rown, sa0] = 0
                dataset_orig_test_4.loc[rown, sa1] = 0
                dataset_orig_test_4.loc[rown, sa2] = 1
            elif dataset_orig_test_4.loc[rown, sa0] == 0 and dataset_orig_test_4.loc[rown, sa1] == 0 and \
                    dataset_orig_test_4.loc[rown, sa2] == 0:
                dataset_orig_test_4.loc[rown, sa0] = 1
                dataset_orig_test_4.loc[rown, sa1] = 0
                dataset_orig_test_4.loc[rown, sa2] = 0
            elif dataset_orig_test_4.loc[rown, sa0] == 1 and dataset_orig_test_4.loc[rown, sa1] == 1 and \
                    dataset_orig_test_4.loc[rown, sa2] == 1:
                dataset_orig_test_4.loc[rown, sa0] = 0
                dataset_orig_test_4.loc[rown, sa1] = 0
                dataset_orig_test_4.loc[rown, sa2] = 1
            elif dataset_orig_test_4.loc[rown, sa0] == 0 and dataset_orig_test_4.loc[rown, sa1] == 1 and \
                    dataset_orig_test_4.loc[rown, sa2] == 1:
                dataset_orig_test_4.loc[rown, sa0] = 0
                dataset_orig_test_4.loc[rown, sa1] = 0
                dataset_orig_test_4.loc[rown, sa2] = 1
