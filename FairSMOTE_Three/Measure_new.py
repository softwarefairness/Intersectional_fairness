...
def wc_spd(dataset_test_pred, p_attrs):
    ...
    return [num1, num2, num3, num4, num5, num6, num7, num8, max([num1, num2, num3, num4, num5, num6, num7, num8]) - min(
...
def wc_aod(dataset_test, dataset_test_pred, p_attrs):
    ...
    num1 = len(dataset_test[(
                                    dataset_test[attr1] == 0) & (dataset_test[attr2] == 0) & (
                                        dataset_test_pred[attr3] == 0) & (dataset_test[
                                                                              labelname] == 0) & (
...
def measure_final_score(dataset_orig_test, clf, X_train, y_train, X_test, y_test,
