...
dataset_orig = pd.read_csv('adult' + "_processed.csv")
a = len(dataset_orig[(dataset_orig['sex']==1)&(dataset_orig['race']==1)&(dataset_orig['Probability']==1)])/len(dataset_orig[(dataset_orig['sex']==1)&(dataset_orig['race']==1)])
b = len(dataset_orig[(dataset_orig['sex']==1)&(dataset_orig['race']==0)&(dataset_orig['Probability']==1)])/len(dataset_orig[(dataset_orig['sex']==1)&(dataset_orig['race']==0)])
c = len(dataset_orig[(dataset_orig['sex']==0)&(dataset_orig['race']==1)&(dataset_orig['Probability']==1)])/len(dataset_orig[(dataset_orig['sex']==0)&(dataset_orig['race']==1)])
d = len(dataset_orig[(dataset_orig['sex']==0)&(dataset_orig['race']==0)&(dataset_orig['Probability']==1)])/len(dataset_orig[(dataset_orig['sex']==0)&(dataset_orig['race']==0)])
print('adult:')
print(a,b,c,d)


'''
dataset_orig = pd.read_csv('german' + "_processed.csv")
p11 = len(dataset_orig[(dataset_orig['Probability']==1)&(dataset_orig['sex']==1)&(dataset_orig['age']==1)])/len(dataset_orig[(dataset_orig['sex']==1)&(dataset_orig['age']==1)])
p10 = len(dataset_orig[(dataset_orig['Probability']==1)&(dataset_orig['sex']==1)&(dataset_orig['age']==0)])/len(dataset_orig[(dataset_orig['sex']==1)&(dataset_orig['age']==0)])
p01 = len(dataset_orig[(dataset_orig['Probability']==1)&(dataset_orig['sex']==0)&(dataset_orig['age']==1)])/len(dataset_orig[(dataset_orig['sex']==0)&(dataset_orig['age']==1)])
p00 = len(dataset_orig[(dataset_orig['Probability']==1)&(dataset_orig['sex']==0)&(dataset_orig['age']==0)])/len(dataset_orig[(dataset_orig['sex']==0)&(dataset_orig['age']==0)])
p1 =  len(dataset_orig[(dataset_orig['Probability']==1)&(dataset_orig['sex']==1)])/ len(dataset_orig[dataset_orig['sex']==1])
p2 =  len(dataset_orig[(dataset_orig['Probability']==1)&(dataset_orig['sex']==0)])/ len(dataset_orig[dataset_orig['sex']==0])
p3 =  len(dataset_orig[(dataset_orig['Probability']==1)&(dataset_orig['age']==1)])/ len(dataset_orig[dataset_orig['age']==1])
p4 =  len(dataset_orig[(dataset_orig['Probability']==1)&(dataset_orig['age']==0)])/ len(dataset_orig[dataset_orig['age']==0])
print(p11,p10,p01,p00,p1,p2,p3,p4)
